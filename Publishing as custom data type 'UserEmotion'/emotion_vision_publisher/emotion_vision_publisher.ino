...
#include <emotion_msgs/UserEmotion.h>
#include "camera.h"
#include "himax.h"
...
ros::NodeHandle nh;
emotion_msgs::UserEmotion emotion_msg;
ros::Publisher emotion_pub("user_emotion_vision", &emotion_msg);
...
bool publishEmotionPrediction(){
    ...
    emotion_msg.angry = result.classification[0].value;
    emotion_msg.happy = result.classification[1].value;
    emotion_msg.neutral = result.classification[2].value;
    emotion_msg.none = result.classification[3].value;
    emotion_msg.sad = result.classification[4].value;
    emotion_msg.angry = result.classification[5].value;
